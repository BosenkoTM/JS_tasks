...
###### 156. Создание функций

Напишите функцию `checkCondition`, которая принимает три булевых значения a, b, c и возвращает результат логического выражения `a || (b && !c)`.

###### 157. Создание функций

Напишите функцию `isEven`, которая принимает число и возвращает `true`, если число четное, и `false` в противном случае.

###### 158. Создание функций

Напишите функцию `findMax`, которая принимает массив чисел и возвращает максимальное число из массива.

###### 159. Создание функций

Напишите функцию `multiplyByTwo`, которая принимает массив чисел и возвращает новый массив, где каждый элемент умножен на 2.

###### 160. Создание функций

Напишите функцию `contains`, которая принимает массив и элемент, и возвращает `true`, если элемент присутствует в массиве, иначе `false`.

###### 161. Создание функций

Напишите функцию `factorial`, которая принимает число `n` и возвращает его факториал.

###### 162. Создание функций

Напишите функцию `power`, которая принимает два числа `base` и `exponent` и возвращает `base` возведенное в степень `exponent`.

###### 163. Создание функций

Напишите функцию average, которая принимает массив чисел и возвращает их среднее арифметическое.

###### 164. Изменение текста элемента по ID

Напишите функцию `changeTextById`, которая принимает `id` элемента и новый `text`, и изменяет текстовое содержимое элемента с данным `id`. Для тестирования без реального `DOM`, функция возвращает объект с `id` и новым `text`.

###### 165. Изменение стиля элемента по классу

Напишите функцию `changeStyleByClass`, которая принимает `className` и объект стилей, и изменяет стили всех элементов с данным классом. Для тестирования без реального DOM, функция возвращает массив объектов с `className` и новыми стилями.

###### 166. Получение значения из поля ввода

Напишите функцию `getInputValue`, которая принимает `id` поля ввода и возвращает его текущее значение. Для тестирования без реального DOM, функция возвращает заданное значение.

###### 167. Обработчик клика на кнопке

Напишите функцию `handleClick, которая вызывается при клике на кнопку и увеличивает счетчик кликов. Для тестирования без реального DOM, функция возвращает увеличенный счетчик.

###### 168. Удаление элемента по ID

Напишите функцию `removeElementById`, которая принимает `id` элемента и удаляет его из DOM. Для тестирования без реального DOM, функция возвращает сообщение об удалении.

###### 169. Добавление элемента в список

Напишите функцию `addItemToList`, которая принимает `id` списка и `itemText`, и добавляет новый элемент списка с заданным текстом. Для тестирования без реального DOM, функция возвращает объект, представляющий обновлённый список.

###### 170. Создание тензора из массива

Напишите функцию `createTensor`, которая принимает массив чисел и возвращает тензор `TensorFlow.js`. Для тестирования без `TensorFlow.js`, функция возвращает строку с описанием тензора.

###### 171. Применение функции активации ReLU к массиву

Напишите функцию `applyReLU`, которая принимает массив чисел и возвращает новый массив, где все отрицательные числа заменены на `0`.

###### 172. Умножение двух массивов поэлементно

Напишите функцию `multiplyArrays`, которая принимает два массива чисел одинаковой длины и возвращает новый массив, где каждый элемент является произведением соответствующих элементов исходных массивов.

###### 173. Загрузка модели

Напишите функцию `loadModel`, которая загружает модель `TensorFlow.js` по заданному URL. Для тестирования без `TensorFlow.js`, функция возвращает строку с URL модели.

###### 174. Преобразование изображения в тензор

Напишите функцию `imageToTensor`, которая принимает изображение и преобразует его в тензор. Для тестирования без `TensorFlow.js`, функция возвращает строку, описывающую преобразование.

###### 175. Нормализация данных

Напишите функцию `normalizeData`, которая принимает массив чисел и возвращает новый массив, нормализованный в диапазоне [0,1].

###### 176. Применение функции активации Sigmoid к массиву

Напишите функцию `applySigmoid`, которая принимает массив чисел и возвращает новый массив, где к каждому элементу применена функция активации `Sigmoid`.

###### 177. Создание модели нейронной сети

Напишите функцию `createSimpleModel`, которая создает простую модель нейронной сети с одним слоем. Для тестирования без `TensorFlow.js`, функция возвращает объект, представляющий модель.

###### 178. Применение функции активации Softmax к массиву

Напишите функцию `applySoftmax`, которая принимает массив чисел и возвращает новый массив, где применена функция активации Softmax.

###### 179. Проверка формы тензора

Напишите функцию `getTensorShape`, которая принимает тензор `TensorFlow.js` и возвращает его форму (размерности). Для тестирования без `TensorFlow.js`, функция возвращает массив с размерами.
